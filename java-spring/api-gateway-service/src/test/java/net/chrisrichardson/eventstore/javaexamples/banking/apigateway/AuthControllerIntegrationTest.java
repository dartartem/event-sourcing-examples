...
import net.chrisrichardson.eventstore.javaexamples.banking.apigateway.controller.AuthController;
...
public class AuthControllerIntegrationTest {
  ...
  public void shouldLogin() throws Exception {
    when(customerAuthService.findByEmailAndPassword("my@email.com", "my_password")).thenReturn(new CustomerView("id", new Name("test", "test"), "my@email.com", "my_password", "ssn", "", new Address(), null));
