...
import net.chrisrichardson.eventstore.javaexamples.banking.apigateway.webapi.ErrorResponse;
...
public class AuthController {
  ...
  public ResponseEntity<CustomerView> doAuth(@RequestBody @Valid UserCredentials request) throws IOException {
    CustomerView customer = customerAuthService.findByEmailAndPassword(request.getEmail(), request.getPassword());
  ...
  public ResponseEntity<CustomerView> getCurrentUser() {
